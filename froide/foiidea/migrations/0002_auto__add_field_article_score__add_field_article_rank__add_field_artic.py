...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('foiidea_article', 'score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Article.rank'
        db.add_column('foiidea_article', 'rank', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Article.order'
        db.add_column('foiidea_article', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.score'
        db.delete_column('foiidea_article', 'score')

        # Deleting field 'Article.rank'
        db.delete_column('foiidea_article', 'rank')

        # Deleting field 'Article.order'
        db.delete_column('foiidea_article', 'order')
