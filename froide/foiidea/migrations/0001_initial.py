...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Source'
        db.create_table('foiidea_source', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('homepage', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('crawler', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('last_crawled', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('foiidea', ['Source'])

        # Adding model 'Article'
        db.create_table('foiidea_article', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foiidea.Source'], null=True)),
        ))
        db.send_create_signal('foiidea', ['Article'])

        # Adding M2M table for field public_bodies on 'Article'
        db.create_table('foiidea_article_public_bodies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['foiidea.article'], null=False)),
            ('publicbody', models.ForeignKey(orm['publicbody.publicbody'], null=False))
        ))
        db.create_unique('foiidea_article_public_bodies', ['article_id', 'publicbody_id'])

        # Adding M2M table for field foirequests on 'Article'
        db.create_table('foiidea_article_foirequests', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['foiidea.article'], null=False)),
            ('foirequest', models.ForeignKey(orm['foirequest.foirequest'], null=False))
        ))
        db.create_unique('foiidea_article_foirequests', ['article_id', 'foirequest_id'])


    def backwards(self, orm):
        
        # Deleting model 'Source'
        db.delete_table('foiidea_source')

        # Deleting model 'Article'
        db.delete_table('foiidea_article')

        # Removing M2M table for field public_bodies on 'Article'
        db.delete_table('foiidea_article_public_bodies')

        # Removing M2M table for field foirequests on 'Article'
        db.delete_table('foiidea_article_foirequests')
    ...
    models = {
        ...
        'foiidea.article': {
            ...
            'foirequests': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['foirequest.FoiRequest']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'public_bodies': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['publicbody.PublicBody']", 'symmetrical': 'False'}),
        ...
        'foiidea.source': {
            ...
            'crawler': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
