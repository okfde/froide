...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeferredMessage.spam'
        db.add_column(u'foirequest_deferredmessage', 'spam',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeferredMessage.spam'
        db.delete_column(u'foirequest_deferredmessage', 'spam')
    ...
    models = {
        u'account.user': {
            ...
            'terms': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'foirequest.foievent': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.User']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        u'foirequest.foimessage': {
            ...
            'sender_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.User']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'foirequest.foirequest': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.User']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        u'publicbody.publicbody': {
            ...
            'classification_slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'blank': 'True'}),
