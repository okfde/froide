...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiMessage.recipient'
        db.add_column('foirequest_foimessage', 'recipient', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiMessage.recipient'
        db.delete_column('foirequest_foimessage', 'recipient')
