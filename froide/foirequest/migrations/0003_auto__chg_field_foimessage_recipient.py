...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoiMessage.recipient'
        db.alter_column('foirequest_foimessage', 'recipient', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'FoiMessage.recipient'
        db.alter_column('foirequest_foimessage', 'recipient', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
