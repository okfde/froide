...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiRequest.same_as'
        db.add_column('foirequest_foirequest', 'same_as', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foirequest.FoiRequest'], null=True, blank=True), keep_default=False)

        # Adding field 'FoiRequest.same_as_count'
        db.add_column('foirequest_foirequest', 'same_as_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiRequest.same_as'
        db.delete_column('foirequest_foirequest', 'same_as_id')

        # Deleting field 'FoiRequest.same_as_count'
        db.delete_column('foirequest_foirequest', 'same_as_count')
