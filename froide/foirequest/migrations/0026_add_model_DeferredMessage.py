...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeferredMessage'
        db.create_table('foirequest_deferredmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipient', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foirequest.FoiRequest'], null=True, blank=True)),
            ('mail', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('foirequest', ['DeferredMessage'])


    def backwards(self, orm):
        # Deleting model 'DeferredMessage'
        db.delete_table('foirequest_deferredmessage')
    ...
    models = {
        ...
        'foirequest.deferredmessage': {
            'Meta': {'object_name': 'DeferredMessage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
