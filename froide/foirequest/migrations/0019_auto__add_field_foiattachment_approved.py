...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiAttachment.approved'
        db.add_column('foirequest_foiattachment', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiAttachment.approved'
        db.delete_column('foirequest_foiattachment', 'approved')
