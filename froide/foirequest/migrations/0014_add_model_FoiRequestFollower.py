...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FoiRequestFollower'
        db.create_table('foirequest_foirequestfollower', (
        ...
        db.send_create_signal('foirequest', ['FoiRequestFollower'])


    def backwards(self, orm):
        
        # Deleting model 'FoiRequestFollower'
        db.delete_table('foirequest_foirequestfollower')
