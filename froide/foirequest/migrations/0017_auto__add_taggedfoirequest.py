...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaggedFoiRequest'
        db.create_table('foirequest_taggedfoirequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='foirequest_taggedfoirequest_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foirequest.FoiRequest'])),
        ))
        db.send_create_signal('foirequest', ['TaggedFoiRequest'])


    def backwards(self, orm):
        
        # Deleting model 'TaggedFoiRequest'
        db.delete_table('foirequest_taggedfoirequest')
