...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiMessage.is_postal'
        db.add_column('foirequest_foimessage', 'is_postal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiMessage.is_postal'
        db.delete_column('foirequest_foimessage', 'is_postal')
