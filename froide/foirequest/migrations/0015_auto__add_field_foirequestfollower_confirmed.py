...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiRequestFollower.confirmed'
        db.add_column('foirequest_foirequestfollower', 'confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiRequestFollower.confirmed'
        db.delete_column('foirequest_foirequestfollower', 'confirmed')
    ...
    models = {
        ...
        'foirequest.foirequest': {
            ...
            'followers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'following_requests'", 'symmetrical': 'False', 'through': "orm['foirequest.FoiRequestFollower']", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'foirequest.foirequestfollower': {
            'Meta': {'ordering': "('timestamp',)", 'object_name': 'FoiRequestFollower'},
