...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiRequest.description'
        db.add_column('foirequest_foirequest', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiRequest.description'
        db.delete_column('foirequest_foirequest', 'description')
