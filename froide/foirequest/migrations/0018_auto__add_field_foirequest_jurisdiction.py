...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiRequest.jurisdiction'
        db.add_column('foirequest_foirequest', 'jurisdiction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicbody.Jurisdiction'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiRequest.jurisdiction'
        db.delete_column('foirequest_foirequest', 'jurisdiction_id')
