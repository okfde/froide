...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicBodySuggestion.reason'
        db.add_column('foirequest_publicbodysuggestion', 'reason', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicBodySuggestion.reason'
        db.delete_column('foirequest_publicbodysuggestion', 'reason')
