...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FoiMessage._visibility'
        db.delete_column('foirequest_foimessage', '_visibility')

        # Deleting field 'FoiMessage._resolution'
        db.delete_column('foirequest_foimessage', '_resolution')

        # Deleting field 'FoiMessage._status'
        db.delete_column('foirequest_foimessage', '_status')


    def backwards(self, orm):
        
        # Adding field 'FoiMessage._visibility'
        db.add_column('foirequest_foimessage', '_visibility', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)

        # Adding field 'FoiMessage._resolution'
        db.add_column('foirequest_foimessage', '_resolution', self.gf('django.db.models.fields.SmallIntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'FoiMessage._status'
        db.add_column('foirequest_foimessage', '_status', self.gf('django.db.models.fields.SmallIntegerField')(default=None, null=True, blank=True), keep_default=False)
