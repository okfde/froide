...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoiEvent.timestamp'
        db.alter_column('foirequest_foievent', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FoiRequest.refusal_reason'
        db.alter_column('foirequest_foirequest', 'refusal_reason', self.gf('django.db.models.fields.CharField')(max_length=1024))


    def backwards(self, orm):
        
        # Changing field 'FoiEvent.timestamp'
        db.alter_column('foirequest_foievent', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'FoiRequest.refusal_reason'
        db.alter_column('foirequest_foirequest', 'refusal_reason', self.gf('django.db.models.fields.CharField')(max_length=255))
