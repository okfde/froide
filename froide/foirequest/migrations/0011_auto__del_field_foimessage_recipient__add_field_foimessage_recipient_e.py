...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('foirequest_foimessage', 'recipient', 'recipient_email')

    def backwards(self, orm):
        
        # Deleting field 'FoiMessage.recipient_email'
        db.rename_column('foirequest_foimessage', 'recipient_email', 'recipient')
