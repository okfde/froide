...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiEvent.public'
        db.add_column('foirequest_foievent', 'public', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiEvent.public'
        db.delete_column('foirequest_foievent', 'public')
