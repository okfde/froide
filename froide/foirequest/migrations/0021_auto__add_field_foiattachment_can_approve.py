...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiAttachment.can_approve'
        db.add_column('foirequest_foiattachment', 'can_approve', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiAttachment.can_approve'
        db.delete_column('foirequest_foiattachment', 'can_approve')
