...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiMessage.not_publishable'
        db.add_column('foirequest_foimessage', 'not_publishable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiMessage.not_publishable'
        db.delete_column('foirequest_foimessage', 'not_publishable')
