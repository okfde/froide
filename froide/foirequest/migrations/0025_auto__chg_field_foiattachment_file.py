...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoiAttachment.file'
        db.alter_column('foirequest_foiattachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'FoiAttachment.file'
        db.alter_column('foirequest_foiattachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
