...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiMessage.recipient_public_body'
        db.add_column('foirequest_foimessage', 'recipient_public_body', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='received_messages', null=True, to=orm['publicbody.PublicBody']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiMessage.recipient_public_body'
        db.delete_column('foirequest_foimessage', 'recipient_public_body_id')
