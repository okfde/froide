...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiAttachment.redacted'
        db.add_column('foirequest_foiattachment', 'redacted', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foirequest.FoiAttachment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiAttachment.redacted'
        db.delete_column('foirequest_foiattachment', 'redacted_id')
