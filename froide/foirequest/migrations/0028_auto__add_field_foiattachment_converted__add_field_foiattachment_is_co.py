...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FoiAttachment.converted'
        db.add_column(u'foirequest_foiattachment', 'converted',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='original_set', null=True, on_delete=models.SET_NULL, to=orm['foirequest.FoiAttachment']),
                      keep_default=False)

        # Adding field 'FoiAttachment.is_converted'
        db.add_column(u'foirequest_foiattachment', 'is_converted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FoiAttachment.converted'
        db.delete_column(u'foirequest_foiattachment', 'converted_id')

        # Deleting field 'FoiAttachment.is_converted'
        db.delete_column(u'foirequest_foiattachment', 'is_converted')
