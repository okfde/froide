...
class DropDownFilterWidget(forms.widgets.ChoiceWidget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        value = super(DropDownFilterWidget, self).render(
    ...
    def get_context(self, name, value, attrs):
        ...
        context = super(DropDownFilterWidget, self).get_context(name, value, attrs)
    ...
    def create_option(
        ...
        option = super(DropDownFilterWidget, self).create_option(
