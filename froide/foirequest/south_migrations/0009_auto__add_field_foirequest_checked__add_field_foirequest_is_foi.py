...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiRequest.checked'
        db.add_column('foirequest_foirequest', 'checked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'FoiRequest.is_foi'
        db.add_column('foirequest_foirequest', 'is_foi', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiRequest.checked'
        db.delete_column('foirequest_foirequest', 'checked')

        # Deleting field 'FoiRequest.is_foi'
        db.delete_column('foirequest_foirequest', 'is_foi')
