...
class AccessTokenTest(TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertIsNotNone(accesstoken.token)
        self.assertIsInstance(accesstoken.token, uuid.UUID)
        self.assertIsNotNone(accesstoken.purpose, str)
        self.assertIsNotNone(accesstoken.user, User)
        self.assertIsNotNone(accesstoken.timestamp, datetime)
