...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'publicbody_publicbodytopic')

        # Deleting field 'PublicBody.topic'
        db.delete_column(u'publicbody_publicbody', 'topic_id')


    def backwards(self, orm):
        # Adding model 'PublicBodyTopic'
        db.create_table(u'publicbody_publicbodytopic', (
        ...
        db.send_create_signal(u'publicbody', ['PublicBodyTopic'])

        # Adding field 'PublicBody.topic'
        db.add_column(u'publicbody_publicbody', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicbody.PublicBodyTopic'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)
