...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedPublicBody'
        db.create_table(u'publicbody_taggedpublicbody', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'publicbody_taggedpublicbody_items', to=orm['publicbody.PublicBodyTag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicbody.PublicBody'])),
        ))
        db.send_create_signal(u'publicbody', ['TaggedPublicBody'])

        # Adding model 'PublicBodyTag'
        db.create_table(u'publicbody_publicbodytag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'publicbody', ['PublicBodyTag'])


    def backwards(self, orm):
        # Deleting model 'TaggedPublicBody'
        db.delete_table(u'publicbody_taggedpublicbody')

        # Deleting model 'PublicBodyTag'
        db.delete_table(u'publicbody_publicbodytag')
