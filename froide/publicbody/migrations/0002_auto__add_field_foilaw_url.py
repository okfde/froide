...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiLaw.url'
        db.add_column('publicbody_foilaw', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiLaw.url'
        db.delete_column('publicbody_foilaw', 'url')
