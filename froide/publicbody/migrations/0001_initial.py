    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "long_description",
                    models.TextField(verbose_name="Website Text", blank=True),
                ),
                (
                    "created",
                    models.DateField(
                        null=True, verbose_name="Creation Date", blank=True
                    ),
                ),
                (
                    "updated",
                    models.DateField(
                        null=True, verbose_name="Updated Date", blank=True
                    ),
                ),
                (
                    "request_note",
                    models.TextField(verbose_name="request note", blank=True),
                ),
                ("meta", models.BooleanField(default=False, verbose_name="Meta Law")),
                (
                    "letter_start",
                    models.TextField(verbose_name="Start of Letter", blank=True),
                ),
                (
                    "letter_end",
                    models.TextField(verbose_name="End of Letter", blank=True),
                ),
                (
                    "priority",
                    models.SmallIntegerField(default=3, verbose_name="Priority"),
                ),
                (
                    "url",
                    models.CharField(max_length=255, verbose_name="URL", blank=True),
                ),
                (
                    "max_response_time",
                    models.IntegerField(
                        default=30,
                        null=True,
                        verbose_name="Maximal Response Time",
                        blank=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            (b"day", "Day(s)"),
                            (b"working_day", "Working Day(s)"),
                            (b"month_de", "Month(s) (DE)"),
                        ],
                    ),
                ),
                (
                    "refusal_reasons",
                    models.TextField(
                        verbose_name="Possible Refusal Reasons, one per line, e.g \xa7X.Y: Privacy Concerns",
                        blank=True,
                    ),
                ),
                (
                    "email_only",
                    models.BooleanField(default=False, verbose_name="E-Mail only"),
                ),
                (
                    "combined",
                    models.ManyToManyField(
                        to="publicbody.FoiLaw", verbose_name="Combined Laws", blank=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "other_names",
                    models.TextField(
                        default=b"", verbose_name="Other names", blank=True
                    ),
                ),
                ("slug", models.SlugField(max_length=255, verbose_name="Slug")),
                (
                ...
                (
                    "url",
                    models.URLField(
                        max_length=500, null=True, verbose_name="URL", blank=True
                    ),
                ),
                ...
                (
                    "classification",
                    models.CharField(
                        max_length=255, verbose_name="Classification", blank=True
                    ),
                ),
                (
                    "classification_slug",
                    models.SlugField(
                        max_length=255, verbose_name="Classification Slug", blank=True
                    ),
                ),
                (
                    "email",
                ...
                (
                    "website_dump",
                    models.TextField(
                        null=True, verbose_name="Website Dump", blank=True
                    ),
                ),
                (
                    "request_note",
                ...
                (
                    "number_of_requests",
                    models.IntegerField(default=0, verbose_name="Number of requests"),
                ),
                (
                    "_created_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_topic",
                    models.BooleanField(default=False, verbose_name="as topic"),
                ),
        ...
        migrations.AddField(
            ...
            field=taggit.managers.TaggableManager(
                to="publicbody.PublicBodyTag",
                through="publicbody.TaggedPublicBody",
                blank=True,
