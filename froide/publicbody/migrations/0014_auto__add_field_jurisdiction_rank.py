...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Jurisdiction.rank'
        db.add_column('publicbody_jurisdiction', 'rank', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Jurisdiction.rank'
        db.delete_column('publicbody_jurisdiction', 'rank')
