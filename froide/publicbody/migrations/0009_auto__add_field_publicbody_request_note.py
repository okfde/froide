...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicBody.request_note'
        db.add_column('publicbody_publicbody', 'request_note', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicBody.request_note'
        db.delete_column('publicbody_publicbody', 'request_note')
