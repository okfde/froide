...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiLaw.created'
        db.add_column('publicbody_foilaw', 'created', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'FoiLaw.updated'
        db.add_column('publicbody_foilaw', 'updated', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiLaw.created'
        db.delete_column('publicbody_foilaw', 'created')

        # Deleting field 'FoiLaw.updated'
        db.delete_column('publicbody_foilaw', 'updated')
