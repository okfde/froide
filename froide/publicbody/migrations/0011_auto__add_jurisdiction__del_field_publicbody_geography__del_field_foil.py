...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('publicbody_jurisdiction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, db_index=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('publicbody', ['Jurisdiction'])

        # Deleting field 'PublicBody.geography'
        db.delete_column('publicbody_publicbody', 'geography')

        # Deleting field 'FoiLaw.jurisdiction'
        db.delete_column('publicbody_foilaw', 'jurisdiction')


    def backwards(self, orm):
        
        # Deleting model 'Jurisdiction'
        db.delete_table('publicbody_jurisdiction')

        # Adding field 'PublicBody.geography'
        db.add_column('publicbody_publicbody', 'geography', self.gf('django.db.models.fields.CharField')(default='Deutschland', max_length=255), keep_default=False)

        # Adding field 'FoiLaw.jurisdiction'
        db.add_column('publicbody_foilaw', 'jurisdiction', self.gf('django.db.models.fields.CharField')(default='Bund', max_length=255), keep_default=False)
