...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PublicBody.url'
        db.alter_column('publicbody_publicbody', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))


    def backwards(self, orm):
        
        # Changing field 'PublicBody.url'
        db.alter_column('publicbody_publicbody', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
