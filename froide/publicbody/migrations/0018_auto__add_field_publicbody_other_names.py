...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicBody.other_names'
        db.add_column('publicbody_publicbody', 'other_names', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicBody.other_names'
        db.delete_column('publicbody_publicbody', 'other_names')
