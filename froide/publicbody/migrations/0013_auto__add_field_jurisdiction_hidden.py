...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Jurisdiction.hidden'
        db.add_column('publicbody_jurisdiction', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Jurisdiction.hidden'
        db.delete_column('publicbody_jurisdiction', 'hidden')
