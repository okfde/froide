...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicBody.jurisdiction'
        db.add_column('publicbody_publicbody', 'jurisdiction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicbody.Jurisdiction'], null=True), keep_default=False)

        # Adding field 'FoiLaw.jurisdiction'
        db.add_column('publicbody_foilaw', 'jurisdiction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicbody.Jurisdiction'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicBody.jurisdiction'
        db.delete_column('publicbody_publicbody', 'jurisdiction_id')

        # Deleting field 'FoiLaw.jurisdiction'
        db.delete_column('publicbody_foilaw', 'jurisdiction_id')
