...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoiLaw.mediator'
        db.add_column('publicbody_foilaw', 'mediator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='mediating_laws', null=True, blank=True, to=orm['publicbody.PublicBody']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoiLaw.mediator'
        db.delete_column('publicbody_foilaw', 'mediator_id')
