...
from .views import (PublicBodyAcceptProposalView, PublicBodyChangeProposalView,
                    PublicBodyProposalView, PublicBodySearch, PublicBodyView,
...
urlpatterns = [
    ...
    path(pgettext_lazy('url part', 'entity/<int:pk>/'), PublicBodyView.as_view(),
            name="publicbody-show"),
    path(pgettext_lazy('url part', 'entity/<int:pk>/<slug:slug>/'), PublicBodyView.as_view(),
            name="publicbody-show"),
    path(pgettext_lazy('url part', 'entity/<slug:slug>/'), PublicBodyView.as_view(),
            name="publicbody-show"),
