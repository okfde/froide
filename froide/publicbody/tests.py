...
def test_publicbody_view_search_filters(
    client, publicbody_data, query_params, expected_names
):
...
def test_publicbody_api_search_filters(
    client, publicbody_data, query_params, expected_names
):
...
def test_publicbody_api_search_invalid_input(client, publicbody_data, api_params):
...
def test_publicbody_api_and_view_return_same_results(client, publicbody_data, params):
