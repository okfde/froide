...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_profile', 'organization',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Profile.organization_url'
        db.add_column('account_profile', 'organization_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('account_profile', 'organization')

        # Deleting field 'Profile.organization_url'
        db.delete_column('account_profile', 'organization_url')
