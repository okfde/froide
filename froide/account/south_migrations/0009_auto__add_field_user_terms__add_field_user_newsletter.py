...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.terms'
        db.add_column(USER_DB_NAME, 'terms',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.newsletter'
        db.add_column(USER_DB_NAME, 'newsletter',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(USER_DB_NAME, 'terms')

        # Deleting field 'User.newsletter'
        db.delete_column(USER_DB_NAME, 'newsletter')
