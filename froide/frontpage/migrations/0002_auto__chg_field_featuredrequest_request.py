...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeaturedRequest.request'
        db.alter_column('frontpage_featuredrequest', 'request_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foirequest.FoiRequest'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FeaturedRequest.request'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedRequest.request' and its values cannot be restored.")
    ...
    models = {
        ...
        'frontpage.featuredrequest': {
            'Meta': {'ordering': "('-timestamp',)", 'object_name': 'FeaturedRequest'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['foirequest.FoiRequest']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'publicbody.publicbody': {
            ...
            '_created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'public_body_creators'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['%s']" % APP_MODEL}),
            '_updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'public_body_updaters'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['%s']" % APP_MODEL}),
