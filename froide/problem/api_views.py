...
class ProblemReportSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id',
            'message_id', 'kind', 'kind_label',
            'message_subject', 'message_url',
            'timestamp', 'auto_submitted', 'resolved', 'resolved',
