...
import {
  ...
  type CreateFoiMessageData,
  type CreateFoiMessageError,
  type CreateFoiMessageResponse,
  type RetrieveFoiMessageData,
  type RetrieveFoiMessageError,
  type RetrieveFoiMessageResponse,
  type UpdateFoiMessageData,
  type UpdateFoiMessageError,
  type UpdateFoiMessageResponse,
  type PartialUpdateFoiMessageData,
  type PartialUpdateFoiMessageError,
  type PartialUpdateFoiMessageResponse,
  type DestroyFoiMessageData,
  type DestroyFoiMessageError,
  type DestroyFoiMessageResponse,
  ...
  CreateFoiMessageResponseTransformer,
  RetrieveFoiMessageResponseTransformer,
  UpdateFoiMessageResponseTransformer,
  PartialUpdateFoiMessageResponseTransformer,
...
export const createFoiMessage = <ThrowOnError extends boolean = false>(
  options?: Options<CreateFoiMessageData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    CreateFoiMessageResponse,
    CreateFoiMessageError,
    ThrowOnError
  >({
    ...options,
    url: '/api/v1/message/',
    responseTransformer: CreateFoiMessageResponseTransformer
  })
}
...
export const updateFoiMessage = <ThrowOnError extends boolean = false>(
  options: Options<UpdateFoiMessageData, ThrowOnError>
) => {
  return (options?.client ?? client).put<
    UpdateFoiMessageResponse,
    UpdateFoiMessageError,
    ThrowOnError
  >({
    ...options,
    url: '/api/v1/message/{id}/',
    responseTransformer: UpdateFoiMessageResponseTransformer
  })
}

export const partialUpdateFoiMessage = <ThrowOnError extends boolean = false>(
  options: Options<PartialUpdateFoiMessageData, ThrowOnError>
) => {
  return (options?.client ?? client).patch<
    PartialUpdateFoiMessageResponse,
    PartialUpdateFoiMessageError,
    ThrowOnError
  >({
    ...options,
    url: '/api/v1/message/{id}/',
    responseTransformer: PartialUpdateFoiMessageResponseTransformer
  })
}

export const destroyFoiMessage = <ThrowOnError extends boolean = false>(
  options: Options<DestroyFoiMessageData, ThrowOnError>
) => {
  return (options?.client ?? client).delete<
    DestroyFoiMessageResponse,
    DestroyFoiMessageError,
    ThrowOnError
  >({
    ...options,
    url: '/api/v1/message/{id}/'
