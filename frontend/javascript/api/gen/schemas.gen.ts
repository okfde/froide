...
export const DocumentSchema = {
    ...
    required: ['cover_image', 'file_url', 'foirequest', 'id', 'last_modified_at', 'original', 'page_template', 'pages_uri', 'publicbody', 'resource_uri', 'site_url', 'uid']
} as const;
...
export const DocumentCollectionSchema = {
    ...
    required: ['cover_image', 'directories', 'document_count', 'document_directory_count', 'documents', 'documents_uri', 'id', 'pages_uri', 'resource_uri', 'site_url', 'uid', 'zip_download_url']
} as const;
...
export const DocumentDetailSchema = {
    ...
    required: ['cover_image', 'file_url', 'foirequest', 'id', 'last_modified_at', 'original', 'page_template', 'pages', 'pages_uri', 'publicbody', 'resource_uri', 'site_url', 'uid']
} as const;
...
export const FoiAttachmentSchema = {
    ...
    required: ['anchor_url', 'belongs_to', 'can_change_approval', 'can_delete', 'can_redact', 'converted', 'document', 'file_url', 'id', 'is_image', 'is_irrelevant', 'is_pdf', 'name', 'redacted', 'resource_uri', 'site_url']
} as const;
...
export const FoiLawSchema = {
    ...
    required: ['combined', 'description', 'id', 'jurisdiction', 'last_modified_at', 'letter_end', 'letter_start', 'long_description', 'mediator', 'name', 'refusal_reasons', 'request_note', 'request_note_html', 'resource_uri', 'site_url', 'slug']
} as const;
...
export const FoiMessageSchema = {
    ...
    required: ['attachments', 'content', 'content_hidden', 'id', 'is_draft', 'is_escalation', 'is_postal', 'is_response', 'kind', 'last_modified_at', 'not_publishable', 'redacted_content', 'redacted_subject', 'request', 'resource_uri', 'sender', 'sent', 'status', 'status_name', 'subject', 'url']
} as const;
...
export const FoiMessageStatusEnumSchema = {
    enum: ['awaiting_user_confirmation', 'publicbody_needed', 'awaiting_publicbody_confirmation', 'awaiting_response', 'awaiting_classification', 'asleep', 'resolved'],
    type: 'string',
...
export const FoiRequestDetailSchema = {
    ...
    required: ['campaign', 'checked', 'costs', 'created_at', 'description', 'due_date', 'id', 'is_foi', 'jurisdiction', 'last_message', 'last_modified_at', 'law', 'messages', 'project', 'public', 'public_body', 'redacted_description', 'reference', 'refusal_reason', 'resolved_on', 'resource_uri', 'same_as', 'same_as_count', 'slug', 'status', 'tags', 'title', 'url', 'user']
} as const;
...
export const FoiRequestFollowSchema = {
    ...
    required: ['can_follow', 'follow_count', 'follows', 'request', 'request_url', 'resource_uri']
} as const;
...
export const FoiRequestListSchema = {
    ...
    required: ['campaign', 'checked', 'costs', 'created_at', 'description', 'due_date', 'id', 'is_foi', 'jurisdiction', 'last_message', 'last_modified_at', 'law', 'project', 'public', 'public_body', 'redacted_description', 'reference', 'refusal_reason', 'resolved_on', 'resource_uri', 'same_as', 'same_as_count', 'slug', 'status', 'tags', 'title', 'url', 'user']
} as const;
...
export const GeoRegionSchema = {
    ...
    required: ['centroid', 'id', 'kind', 'name', 'part_of', 'resource_uri', 'slug']
} as const;
...
export const GeoRegionDetailSchema = {
    ...
    required: ['centroid', 'geom', 'gov_seat', 'id', 'kind', 'name', 'part_of', 'resource_uri', 'slug']
} as const;
...
export const JurisdictionSchema = {
    ...
    required: ['id', 'last_modified_at', 'name', 'region', 'resource_uri', 'site_url', 'slug']
} as const;

export const KindCfdEnumSchema = {
    enum: ['country', 'state', 'admin_district', 'district', 'admin_cooperation', 'municipality', 'borough', 'zipcode', 'admin_court_jurisdiction'],
    type: 'string',
...
export const ProblemReportSchema = {
    ...
    required: ['id', 'is_requester', 'kind', 'kind_label', 'message_id', 'message_subject', 'message_url', 'moderator_id', 'related_publicbody_id']
} as const;

export const ProblemReportKindEnumSchema = {
    enum: ['message_not_delivered', 'attachment_broken', 'redaction_needed', 'foi_help_needed', 'other', 'not_foi', 'not_nice', 'info_outdated', 'info_wrong', 'bounce_publicbody', 'mail_inauthentic'],
    type: 'string',
...
export const PublicBodySchema = {
    ...
    required: ['categories', 'classification', 'geo', 'id', 'jurisdiction', 'laws', 'name', 'parent', 'regions', 'request_note_html', 'resource_uri', 'root', 'site_url', 'slug']
} as const;
...
export const ResolutionEnumSchema = {
    enum: ['successful', 'partially_successful', 'not_held', 'refused', 'user_withdrew_costs', 'user_withdrew'],
    type: 'string',
...
export const SimplePublicBodySchema = {
    ...
    required: ['classification', 'geo', 'id', 'jurisdiction', 'last_modified_at', 'name', 'request_note_html', 'resource_uri', 'site_url', 'slug']
} as const;
