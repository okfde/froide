...
export type FoiMessage = {
    ...
    readonly kind: (FoiMessageKindEnum);
    ...
    readonly status: (FoiMessageStatusEnum | BlankEnum);
    timestamp?: Date;
 ...
 */
export type FoiMessageKindEnum = 'email' | 'post' | 'fax' | 'upload' | 'phone' | 'visit' | 'import';
 ...
 */
export type FoiMessageStatusEnum = 'awaiting_user_confirmation' | 'publicbody_needed' | 'awaiting_publicbody_confirmation' | 'awaiting_response' | 'awaiting_classification' | 'asleep' | 'resolved';
 ...
 */
export type KindCfdEnum = 'country' | 'state' | 'admin_district' | 'district' | 'admin_cooperation' | 'municipality' | 'borough' | 'zipcode' | 'admin_court_jurisdiction';
 ...
 */
export type ProblemReportKindEnum = 'message_not_delivered' | 'attachment_broken' | 'redaction_needed' | 'foi_help_needed' | 'other' | 'not_foi' | 'not_nice' | 'info_outdated' | 'info_wrong' | 'bounce_publicbody' | 'mail_inauthentic';
 ...
 */
export type ResolutionEnum = 'successful' | 'partially_successful' | 'not_held' | 'refused' | 'user_withdrew_costs' | 'user_withdrew';
...
export type MessagePublishCreateResponse = (FoiMessage);

export type MessagePublishCreateError = unknown;
...
export type PublicbodyReconciliationProposePropertiesRetrieveResponse = (PublicBodyList);
...
export type PublicbodyReconciliationProposePropertiesCreateResponse = (PublicBodyList);
...
export type PublicbodyReconciliationSuggestServiceRetrieveResponse = (PublicBodyList);
...
export type PublicbodyReconciliationSuggestServiceCreateResponse = (PublicBodyList);
...
export type RequestListData = {
    query?: {
         ...
         * * `user_withdrew` - Request was withdrawn
         */
        resolution?: 'not_held' | 'partially_successful' | 'refused' | 'successful' | 'user_withdrew' | 'user_withdrew_costs';
        slug?: string;
        /**
         * * `awaiting_user_confirmation` - Awaiting user confirmation
         * * `publicbody_needed` - Public Body needed
         ...
         * * `resolved` - Request resolved
         */
        status?: 'asleep' | 'awaiting_classification' | 'awaiting_publicbody_confirmation' | 'awaiting_response' | 'awaiting_user_confirmation' | 'publicbody_needed' | 'resolved';
        tags?: string;
        user?: number;
    };
};
...
export type SchemaRetrieveData = {
    query?: {
        lang?: 'da-dk' | 'de' | 'en' | 'es' | 'fi-fi' | 'it' | 'pt' | 'sv-fi' | 'sv-se' | 'zh-cn' | 'zh-hk';
    };
};
...
export type AttachmentListResponseTransformer = (data: any) => Promise<AttachmentListResponse>;

export type PaginatedFoiAttachmentListModelResponseTransformer = (data: any) => PaginatedFoiAttachmentList;
...
export const DocumentModelResponseTransformer: DocumentModelResponseTransformer = data => {
...
export const FoiAttachmentModelResponseTransformer: FoiAttachmentModelResponseTransformer = data => {
    if (data?.document) {
...
export const PaginatedFoiAttachmentListModelResponseTransformer: PaginatedFoiAttachmentListModelResponseTransformer = data => {
...
export const AttachmentListResponseTransformer: AttachmentListResponseTransformer = async (data) => {
    PaginatedFoiAttachmentListModelResponseTransformer(data);
    return data;
};

export type AttachmentCreateResponseTransformer = (data: any) => Promise<AttachmentCreateResponse>;

export const AttachmentCreateResponseTransformer: AttachmentCreateResponseTransformer = async (data) => {
    FoiAttachmentModelResponseTransformer(data);
    return data;
};

export type AttachmentRetrieveResponseTransformer = (data: any) => Promise<AttachmentRetrieveResponse>;

export const AttachmentRetrieveResponseTransformer: AttachmentRetrieveResponseTransformer = async (data) => {
    FoiAttachmentModelResponseTransformer(data);
    return data;
};

export type AttachmentApproveCreateResponseTransformer = (data: any) => Promise<AttachmentApproveCreateResponse>;

export const AttachmentApproveCreateResponseTransformer: AttachmentApproveCreateResponseTransformer = async (data) => {
    FoiAttachmentModelResponseTransformer(data);
    return data;
};

export type AttachmentToDocumentCreateResponseTransformer = (data: any) => Promise<AttachmentToDocumentCreateResponse>;

export const AttachmentToDocumentCreateResponseTransformer: AttachmentToDocumentCreateResponseTransformer = async (data) => {
    DocumentModelResponseTransformer(data);
    return data;
};

export type AttachmentUnapproveCreateResponseTransformer = (data: any) => Promise<AttachmentUnapproveCreateResponse>;

export const AttachmentUnapproveCreateResponseTransformer: AttachmentUnapproveCreateResponseTransformer = async (data) => {
    FoiAttachmentModelResponseTransformer(data);
    return data;
};

export type ConvertImagesToPdfResponseTransformer = (data: any) => Promise<ConvertImagesToPdfResponse>;

export const ConvertImagesToPdfResponseTransformer: ConvertImagesToPdfResponseTransformer = async (data) => {
    FoiAttachmentModelResponseTransformer(data);
    return data;
};

export type CampaignListResponseTransformer = (data: any) => Promise<CampaignListResponse>;

export type PaginatedCampaignListModelResponseTransformer = (data: any) => PaginatedCampaignList;

export type CampaignModelResponseTransformer = (data: any) => Campaign;

export const CampaignModelResponseTransformer: CampaignModelResponseTransformer = data => {
    if (data?.start_date) {
...
export const PaginatedCampaignListModelResponseTransformer: PaginatedCampaignListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const CampaignListResponseTransformer: CampaignListResponseTransformer = async (data) => {
    PaginatedCampaignListModelResponseTransformer(data);
    return data;
};

export type CampaignRetrieveResponseTransformer = (data: any) => Promise<CampaignRetrieveResponse>;

export const CampaignRetrieveResponseTransformer: CampaignRetrieveResponseTransformer = async (data) => {
    CampaignModelResponseTransformer(data);
    return data;
};

export type DocumentListResponseTransformer = (data: any) => Promise<DocumentListResponse>;

export type PaginatedDocumentListModelResponseTransformer = (data: any) => PaginatedDocumentList;

export const PaginatedDocumentListModelResponseTransformer: PaginatedDocumentListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const DocumentListResponseTransformer: DocumentListResponseTransformer = async (data) => {
    PaginatedDocumentListModelResponseTransformer(data);
    return data;
};

export type DocumentRetrieveResponseTransformer = (data: any) => Promise<DocumentRetrieveResponse>;

export type DocumentDetailModelResponseTransformer = (data: any) => DocumentDetail;

export const DocumentDetailModelResponseTransformer: DocumentDetailModelResponseTransformer = data => {
    if (data?.published_at) {
        data.published_at = new Date(data.published_at);
    }
    return data;
...
export const DocumentRetrieveResponseTransformer: DocumentRetrieveResponseTransformer = async (data) => {
    DocumentDetailModelResponseTransformer(data);
    return data;
};

export type DocumentPartialUpdateResponseTransformer = (data: any) => Promise<DocumentPartialUpdateResponse>;

export const DocumentPartialUpdateResponseTransformer: DocumentPartialUpdateResponseTransformer = async (data) => {
    DocumentModelResponseTransformer(data);
    return data;
};

export type DocumentOembedRetrieveResponseTransformer = (data: any) => Promise<DocumentOembedRetrieveResponse>;

export const DocumentOembedRetrieveResponseTransformer: DocumentOembedRetrieveResponseTransformer = async (data) => {
    DocumentModelResponseTransformer(data);
    return data;
};

export type DocumentcollectionListResponseTransformer = (data: any) => Promise<DocumentcollectionListResponse>;

export type PaginatedDocumentCollectionListModelResponseTransformer = (data: any) => PaginatedDocumentCollectionList;

export type DocumentCollectionModelResponseTransformer = (data: any) => DocumentCollection;

export const DocumentCollectionModelResponseTransformer: DocumentCollectionModelResponseTransformer = data => {
    if (data?.created_at) {
...
export const PaginatedDocumentCollectionListModelResponseTransformer: PaginatedDocumentCollectionListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const DocumentcollectionListResponseTransformer: DocumentcollectionListResponseTransformer = async (data) => {
    PaginatedDocumentCollectionListModelResponseTransformer(data);
    return data;
};

export type DocumentcollectionRetrieveResponseTransformer = (data: any) => Promise<DocumentcollectionRetrieveResponse>;

export const DocumentcollectionRetrieveResponseTransformer: DocumentcollectionRetrieveResponseTransformer = async (data) => {
    DocumentCollectionModelResponseTransformer(data);
    return data;
};

export type DocumentcollectionOembedRetrieveResponseTransformer = (data: any) => Promise<DocumentcollectionOembedRetrieveResponse>;

export const DocumentcollectionOembedRetrieveResponseTransformer: DocumentcollectionOembedRetrieveResponseTransformer = async (data) => {
    DocumentCollectionModelResponseTransformer(data);
    return data;
};

export type FollowingListResponseTransformer = (data: any) => Promise<FollowingListResponse>;

export type PaginatedFoiRequestFollowListModelResponseTransformer = (data: any) => PaginatedFoiRequestFollowList;

export type FoiRequestFollowModelResponseTransformer = (data: any) => FoiRequestFollow;

export const FoiRequestFollowModelResponseTransformer: FoiRequestFollowModelResponseTransformer = data => {
    if (data?.timestamp) {
...
export const PaginatedFoiRequestFollowListModelResponseTransformer: PaginatedFoiRequestFollowListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const FollowingListResponseTransformer: FollowingListResponseTransformer = async (data) => {
    PaginatedFoiRequestFollowListModelResponseTransformer(data);
    return data;
};

export type GeoregionListResponseTransformer = (data: any) => Promise<GeoregionListResponse>;

export type PaginatedGeoRegionListModelResponseTransformer = (data: any) => PaginatedGeoRegionList;

export type GeoRegionModelResponseTransformer = (data: any) => GeoRegion;

export const GeoRegionModelResponseTransformer: GeoRegionModelResponseTransformer = data => {
    if (data?.valid_on) {
...
export const PaginatedGeoRegionListModelResponseTransformer: PaginatedGeoRegionListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const GeoregionListResponseTransformer: GeoregionListResponseTransformer = async (data) => {
    PaginatedGeoRegionListModelResponseTransformer(data);
    return data;
};

export type GeoregionRetrieveResponseTransformer = (data: any) => Promise<GeoregionRetrieveResponse>;

export type GeoRegionDetailModelResponseTransformer = (data: any) => GeoRegionDetail;

export const GeoRegionDetailModelResponseTransformer: GeoRegionDetailModelResponseTransformer = data => {
    if (data?.valid_on) {
        data.valid_on = new Date(data.valid_on);
    }
    return data;
...
export const GeoregionRetrieveResponseTransformer: GeoregionRetrieveResponseTransformer = async (data) => {
    GeoRegionDetailModelResponseTransformer(data);
    return data;
};

export type GeoregionAutocompleteRetrieveResponseTransformer = (data: any) => Promise<GeoregionAutocompleteRetrieveResponse>;

export const GeoregionAutocompleteRetrieveResponseTransformer: GeoregionAutocompleteRetrieveResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationRetrieveResponseTransformer = (data: any) => Promise<GeoregionReconciliationRetrieveResponse>;

export const GeoregionReconciliationRetrieveResponseTransformer: GeoregionReconciliationRetrieveResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationCreateResponseTransformer = (data: any) => Promise<GeoregionReconciliationCreateResponse>;

export const GeoregionReconciliationCreateResponseTransformer: GeoregionReconciliationCreateResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationFlyoutRetrieveResponseTransformer = (data: any) => Promise<GeoregionReconciliationFlyoutRetrieveResponse>;

export const GeoregionReconciliationFlyoutRetrieveResponseTransformer: GeoregionReconciliationFlyoutRetrieveResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationFlyoutCreateResponseTransformer = (data: any) => Promise<GeoregionReconciliationFlyoutCreateResponse>;

export const GeoregionReconciliationFlyoutCreateResponseTransformer: GeoregionReconciliationFlyoutCreateResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationProposePropertiesRetrieveResponseTransformer = (data: any) => Promise<GeoregionReconciliationProposePropertiesRetrieveResponse>;

export const GeoregionReconciliationProposePropertiesRetrieveResponseTransformer: GeoregionReconciliationProposePropertiesRetrieveResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationProposePropertiesCreateResponseTransformer = (data: any) => Promise<GeoregionReconciliationProposePropertiesCreateResponse>;

export const GeoregionReconciliationProposePropertiesCreateResponseTransformer: GeoregionReconciliationProposePropertiesCreateResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationSuggestServiceRetrieveResponseTransformer = (data: any) => Promise<GeoregionReconciliationSuggestServiceRetrieveResponse>;

export const GeoregionReconciliationSuggestServiceRetrieveResponseTransformer: GeoregionReconciliationSuggestServiceRetrieveResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type GeoregionReconciliationSuggestServiceCreateResponseTransformer = (data: any) => Promise<GeoregionReconciliationSuggestServiceCreateResponse>;

export const GeoregionReconciliationSuggestServiceCreateResponseTransformer: GeoregionReconciliationSuggestServiceCreateResponseTransformer = async (data) => {
    GeoRegionModelResponseTransformer(data);
    return data;
};

export type JurisdictionListResponseTransformer = (data: any) => Promise<JurisdictionListResponse>;

export type PaginatedJurisdictionListModelResponseTransformer = (data: any) => PaginatedJurisdictionList;

export type JurisdictionModelResponseTransformer = (data: any) => Jurisdiction;

export const JurisdictionModelResponseTransformer: JurisdictionModelResponseTransformer = data => {
...
export const PaginatedJurisdictionListModelResponseTransformer: PaginatedJurisdictionListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const JurisdictionListResponseTransformer: JurisdictionListResponseTransformer = async (data) => {
    PaginatedJurisdictionListModelResponseTransformer(data);
    return data;
};

export type JurisdictionRetrieveResponseTransformer = (data: any) => Promise<JurisdictionRetrieveResponse>;

export const JurisdictionRetrieveResponseTransformer: JurisdictionRetrieveResponseTransformer = async (data) => {
...
export type PaginatedFoiLawListModelResponseTransformer = (data: any) => PaginatedFoiLawList;

export type FoiLawModelResponseTransformer = (data: any) => FoiLaw;

export const FoiLawModelResponseTransformer: FoiLawModelResponseTransformer = data => {
    if (data?.created) {
...
export const PaginatedFoiLawListModelResponseTransformer: PaginatedFoiLawListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const LawListResponseTransformer: LawListResponseTransformer = async (data) => {
    PaginatedFoiLawListModelResponseTransformer(data);
    return data;
};

export type LawRetrieveResponseTransformer = (data: any) => Promise<LawRetrieveResponse>;

export const LawRetrieveResponseTransformer: LawRetrieveResponseTransformer = async (data) => {
    FoiLawModelResponseTransformer(data);
    return data;
};

export type LawAutocompleteRetrieveResponseTransformer = (data: any) => Promise<LawAutocompleteRetrieveResponse>;

export const LawAutocompleteRetrieveResponseTransformer: LawAutocompleteRetrieveResponseTransformer = async (data) => {
    FoiLawModelResponseTransformer(data);
    return data;
};

export type MessageListResponseTransformer = (data: any) => Promise<MessageListResponse>;

export type PaginatedFoiMessageListModelResponseTransformer = (data: any) => PaginatedFoiMessageList;

export type FoiMessageModelResponseTransformer = (data: any) => FoiMessage;

export const FoiMessageModelResponseTransformer: FoiMessageModelResponseTransformer = data => {
    if (data?.timestamp) {
        data.timestamp = new Date(data.timestamp);
    }
...
export const PaginatedFoiMessageListModelResponseTransformer: PaginatedFoiMessageListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const MessageListResponseTransformer: MessageListResponseTransformer = async (data) => {
    PaginatedFoiMessageListModelResponseTransformer(data);
    return data;
};

export type MessageRetrieveResponseTransformer = (data: any) => Promise<MessageRetrieveResponse>;

export const MessageRetrieveResponseTransformer: MessageRetrieveResponseTransformer = async (data) => {
    FoiMessageModelResponseTransformer(data);
    return data;
};

export type MessageUpdateResponseTransformer = (data: any) => Promise<MessageUpdateResponse>;

export const MessageUpdateResponseTransformer: MessageUpdateResponseTransformer = async (data) => {
    FoiMessageModelResponseTransformer(data);
    return data;
};

export type MessagePartialUpdateResponseTransformer = (data: any) => Promise<MessagePartialUpdateResponse>;

export const MessagePartialUpdateResponseTransformer: MessagePartialUpdateResponseTransformer = async (data) => {
    FoiMessageModelResponseTransformer(data);
    return data;
};

export type MessagePublishCreateResponseTransformer = (data: any) => Promise<MessagePublishCreateResponse>;

export const MessagePublishCreateResponseTransformer: MessagePublishCreateResponseTransformer = async (data) => {
    FoiMessageModelResponseTransformer(data);
    return data;
};

export type PageannotationListResponseTransformer = (data: any) => Promise<PageannotationListResponse>;

export type PaginatedPageAnnotationListModelResponseTransformer = (data: any) => PaginatedPageAnnotationList;

export type PageAnnotationModelResponseTransformer = (data: any) => PageAnnotation;

export const PageAnnotationModelResponseTransformer: PageAnnotationModelResponseTransformer = data => {
    if (data?.timestamp) {
        data.timestamp = new Date(data.timestamp);
    }
    return data;
...
export const PaginatedPageAnnotationListModelResponseTransformer: PaginatedPageAnnotationListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const PageannotationListResponseTransformer: PageannotationListResponseTransformer = async (data) => {
    PaginatedPageAnnotationListModelResponseTransformer(data);
    return data;
};

export type PageannotationRetrieveResponseTransformer = (data: any) => Promise<PageannotationRetrieveResponse>;

export const PageannotationRetrieveResponseTransformer: PageannotationRetrieveResponseTransformer = async (data) => {
    PageAnnotationModelResponseTransformer(data);
    return data;
};

export type ProblemreportListResponseTransformer = (data: any) => Promise<ProblemreportListResponse>;

export type PaginatedProblemReportListModelResponseTransformer = (data: any) => PaginatedProblemReportList;

export type ProblemReportModelResponseTransformer = (data: any) => ProblemReport;

export const ProblemReportModelResponseTransformer: ProblemReportModelResponseTransformer = data => {
    if (data?.timestamp) {
        data.timestamp = new Date(data.timestamp);
    }
...
export const PaginatedProblemReportListModelResponseTransformer: PaginatedProblemReportListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const ProblemreportListResponseTransformer: ProblemreportListResponseTransformer = async (data) => {
    PaginatedProblemReportListModelResponseTransformer(data);
    return data;
};

export type ProblemreportRetrieveResponseTransformer = (data: any) => Promise<ProblemreportRetrieveResponse>;

export const ProblemreportRetrieveResponseTransformer: ProblemreportRetrieveResponseTransformer = async (data) => {
    ProblemReportModelResponseTransformer(data);
    return data;
};

export type ProblemreportClaimCreateResponseTransformer = (data: any) => Promise<ProblemreportClaimCreateResponse>;

export const ProblemreportClaimCreateResponseTransformer: ProblemreportClaimCreateResponseTransformer = async (data) => {
    ProblemReportModelResponseTransformer(data);
    return data;
};

export type ProblemreportEscalateCreateResponseTransformer = (data: any) => Promise<ProblemreportEscalateCreateResponse>;

export const ProblemreportEscalateCreateResponseTransformer: ProblemreportEscalateCreateResponseTransformer = async (data) => {
    ProblemReportModelResponseTransformer(data);
    return data;
};

export type ProblemreportResolveCreateResponseTransformer = (data: any) => Promise<ProblemreportResolveCreateResponse>;

export const ProblemreportResolveCreateResponseTransformer: ProblemreportResolveCreateResponseTransformer = async (data) => {
    ProblemReportModelResponseTransformer(data);
    return data;
};

export type ProblemreportUnclaimCreateResponseTransformer = (data: any) => Promise<ProblemreportUnclaimCreateResponse>;

export const ProblemreportUnclaimCreateResponseTransformer: ProblemreportUnclaimCreateResponseTransformer = async (data) => {
    ProblemReportModelResponseTransformer(data);
    return data;
};

export type PublicbodyRetrieveResponseTransformer = (data: any) => Promise<PublicbodyRetrieveResponse>;

export type PublicBodyModelResponseTransformer = (data: any) => PublicBody;

export const PublicBodyModelResponseTransformer: PublicBodyModelResponseTransformer = data => {
...
export const PublicbodyRetrieveResponseTransformer: PublicbodyRetrieveResponseTransformer = async (data) => {
    PublicBodyModelResponseTransformer(data);
    return data;
};

export type RequestListResponseTransformer = (data: any) => Promise<RequestListResponse>;

export type PaginatedFoiRequestListListModelResponseTransformer = (data: any) => PaginatedFoiRequestListList;

export type FoiRequestListModelResponseTransformer = (data: any) => FoiRequestList;

export const FoiRequestListModelResponseTransformer: FoiRequestListModelResponseTransformer = data => {
    if (data?.due_date) {
...
export const PaginatedFoiRequestListListModelResponseTransformer: PaginatedFoiRequestListListModelResponseTransformer = data => {
    if (Array.isArray(data?.results)) {
...
export const RequestListResponseTransformer: RequestListResponseTransformer = async (data) => {
    PaginatedFoiRequestListListModelResponseTransformer(data);
    return data;
};

export type RequestRetrieveResponseTransformer = (data: any) => Promise<RequestRetrieveResponse>;

export type FoiRequestDetailModelResponseTransformer = (data: any) => FoiRequestDetail;

export const FoiRequestDetailModelResponseTransformer: FoiRequestDetailModelResponseTransformer = data => {
    if (data?.due_date) {
        data.due_date = new Date(data.due_date);
    }
    if (data?.resolved_on) {
...
export const RequestRetrieveResponseTransformer: RequestRetrieveResponseTransformer = async (data) => {
    FoiRequestDetailModelResponseTransformer(data);
    return data;
};

export type RequestUpdateResponseTransformer = (data: any) => Promise<RequestUpdateResponse>;

export const RequestUpdateResponseTransformer: RequestUpdateResponseTransformer = async (data) => {
    FoiRequestListModelResponseTransformer(data);
    return data;
};

export type RequestPartialUpdateResponseTransformer = (data: any) => Promise<RequestPartialUpdateResponse>;

export const RequestPartialUpdateResponseTransformer: RequestPartialUpdateResponseTransformer = async (data) => {
    FoiRequestListModelResponseTransformer(data);
    return data;
};

export type RequestSearchRetrieveResponseTransformer = (data: any) => Promise<RequestSearchRetrieveResponse>;

export const RequestSearchRetrieveResponseTransformer: RequestSearchRetrieveResponseTransformer = async (data) => {
    FoiRequestListModelResponseTransformer(data);
    return data;
};

export type RequestTagsAutocompleteRetrieveResponseTransformer = (data: any) => Promise<RequestTagsAutocompleteRetrieveResponse>;

export const RequestTagsAutocompleteRetrieveResponseTransformer: RequestTagsAutocompleteRetrieveResponseTransformer = async (data) => {
    FoiRequestListModelResponseTransformer(data);
    return data;
};

export type UploadCreateResponseTransformer = (data: any) => Promise<UploadCreateResponse>;

export type UploadCreateModelResponseTransformer = (data: any) => UploadCreate;

export const UploadCreateModelResponseTransformer: UploadCreateModelResponseTransformer = data => {
    if (data?.expires) {
...
export const UploadCreateResponseTransformer: UploadCreateResponseTransformer = async (data) => {
    UploadCreateModelResponseTransformer(data);
    return data;
};

export type UploadUpdateResponseTransformer = (data: any) => Promise<UploadUpdateResponse>;

export type UploadModelResponseTransformer = (data: any) => Upload;

export const UploadModelResponseTransformer: UploadModelResponseTransformer = data => {
    if (data?.expires) {
        data.expires = new Date(data.expires);
    }
    return data;
...
export const UploadUpdateResponseTransformer: UploadUpdateResponseTransformer = async (data) => {
    UploadModelResponseTransformer(data);
    return data;
};

export type UploadPartialUpdateResponseTransformer = (data: any) => Promise<UploadPartialUpdateResponse>;

export const UploadPartialUpdateResponseTransformer: UploadPartialUpdateResponseTransformer = async (data) => {
    UploadModelResponseTransformer(data);
    return data;
};